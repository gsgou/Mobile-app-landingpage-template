...
agree that, where Quikkauf has been provided to them via the Apple App
...
-   [API terms](https://policies.google.com/terms)

## What the User should know at a glance

-   The Service/Quikkauf is only intended for Consumers.
...
apply generally when using Quikkauf.
...
By using Quikkauf, Users confirm to meet the following requirements:
...
available on Quikkauf is owned or provided by the Owner or its
licensors.

The Owner undertakes its utmost effort to ensure that the content
provided on Quikkauf infringes no applicable legal provisions or
...
#### Rights regarding content on Quikkauf - All rights reserved
...
Quikkauf, nor allow any third party to do so through the User or their
device, even without the User\'s knowledge.

Where explicitly stated on Quikkauf, the User may download, copy and/or
share some content available through Quikkauf for its sole personal and
...
Through Quikkauf Users may have access to external resources provided by
...
Quikkauf and the Service may only be used within the scope of what they
are provided for, under these Terms and applicable law.

Users are solely responsible for making sure that their use of Quikkauf
...
Quikkauf or the Service, terminating contracts, reporting any misconduct
performed through Quikkauf or the Service to the competent authorities
...
Quikkauf or specific Products available for sale on Quikkauf must be
...
long as Quikkauf has been appropriately and correctly used by the User.
...
**Quikkauf is provided strictly on an "as is" and "as available" basis.
...
portion of Quikkauf and of its Service without the Owner's express prior
...
the privacy policy of Quikkauf.
...
patent rights and design rights related to Quikkauf are the exclusive
...
appearing in connection with Quikkauf are, and remain, the exclusive
property of the Owner or its licensors and are subject to the protection
...
All communications relating to the use of Quikkauf must be sent using
...
Indicates the natural person(s) or legal entity that provides Quikkauf
and/or the Service to Users.

#### Service

The service provided by Quikkauf as described in these Terms and on
Quikkauf.

#### Terms

All provisions applicable to the use of Quikkauf and/or the Service as
described in this document, including any other related documents or
agreements, and as updated from time to time.

#### User (or You)

Indicates any natural person or legal entity using Quikkauf.
